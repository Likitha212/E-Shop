   ...
   <div className='min-h-[550px] flex justify-center  items-center py-12'>
      <div  className='container'>
        <div style={{backgroundColor: data.bgColor}}
          ...
          {/* third col */}
          <div className='flex flex-col justify-center p-6 gap-4 sm:p-8'>
            ...
            <p data-aos ="fade-uo"className='text-sm tracking-wide leading-5'>{data.title4}</p>
            <div data-aos="fade-up" data-aos-offset="0">
              <button style={{color: data.bgColor}}
               className='py-2 px-4 bg-white rounded-full cursor-pointer hover:scale-105 duration-300'>Shop Now</button>
            </div>
          </div>
        </div>
      </div>
